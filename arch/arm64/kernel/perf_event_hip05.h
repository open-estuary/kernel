...
enum armv8_hisi_mn_event_types {
	...
	ARMV8_HISI_PERFCTR_MN_S0_TC_DVM_OP_REQ			= 0x32E,
	ARMV8_HISI_PERFCTR_MN_S0_TC_DVM_SYNC_REQ		= 0x32F,
	ARMV8_HISI_PERFCTR_MN_S0_TC_READ_REQ			= 0x330,
	ARMV8_HISI_PERFCTR_MN_S0_TC_WRITE_REQ			= 0x331,
	ARMV8_HISI_PERFCTR_MN_S0_TC_COPYBK_REQ			= 0x332,
	ARMV8_HISI_PERFCTR_MN_S0_TC_OTHER_REQ			= 0x333,
	ARMV8_HISI_PERFCTR_MN_S0_TC_RETRY_REQ			= 0x334,
	ARMV8_HISI_PERFCTR_MN_S0_TA_EO_BARR_REQ			= 0x335,
	ARMV8_HISI_PERFCTR_MN_S0_TA_EC_BARR_REQ			= 0x336,
	ARMV8_HISI_PERFCTR_MN_S0_TA_DVM_OP_REQ			= 0x337,
	ARMV8_HISI_PERFCTR_MN_S0_TA_DVM_SYNC_REQ		= 0x338,
	ARMV8_HISI_PERFCTR_MN_S0_TA_READ_REQ			= 0x339,
	ARMV8_HISI_PERFCTR_MN_S0_TA_WRITE_REQ			= 0x33A,
	ARMV8_HISI_PERFCTR_MN_S0_TA_COPYBK_REQ			= 0x33B,
	ARMV8_HISI_PERFCTR_MN_S0_TA_OTHER_REQ			= 0x33C,
	ARMV8_HISI_PERFCTR_MN_S0_TA_RETRY_REQ			= 0x33D,
...
enum armv8_hisi_ddr_event_types {
        ARMV8_HISI_PERFCTR_DDRC0_TC_FLUX_READ_BW		= 0x33E,
        ARMV8_HISI_PERFCTR_DDRC0_TC_FLUX_WRITE_BW		= 0x33F,
        ARMV8_HISI_PERFCTR_DDRC0_TC_FLUX_READ_LAT		= 0x340,
        ARMV8_HISI_PERFCTR_DDRC0_TC_FLUX_WRITE_LAT		= 0x341,
        ARMV8_HISI_PERFCTR_DDRC1_TC_FLUX_READ_BW		= 0x342,
        ARMV8_HISI_PERFCTR_DDRC1_TC_FLUX_WRITE_BW		= 0x343,
        ARMV8_HISI_PERFCTR_DDRC1_TC_FLUX_READ_LAT		= 0x344,
        ARMV8_HISI_PERFCTR_DDRC1_TC_FLUX_WRITE_LAT		= 0x345,
        ARMV8_HISI_PERFCTR_DDRC0_TA_FLUX_READ_BW		= 0x346,
        ARMV8_HISI_PERFCTR_DDRC0_TA_FLUX_WRITE_BW		= 0x347,
        ARMV8_HISI_PERFCTR_DDRC0_TA_FLUX_READ_LAT		= 0x348,
        ARMV8_HISI_PERFCTR_DDRC0_TA_FLUX_WRITE_LAT		= 0x349,
        ARMV8_HISI_PERFCTR_DDRC1_TA_FLUX_READ_BW		= 0x34A,
        ARMV8_HISI_PERFCTR_DDRC1_TA_FLUX_WRITE_BW		= 0x34B,
        ARMV8_HISI_PERFCTR_DDRC1_TA_FLUX_READ_LAT		= 0x34C,
        ARMV8_HISI_PERFCTR_DDRC1_TA_FLUX_WRITE_LAT		= 0x34D,
