...
typedef enum _logical_chip_type_t
{
    ...
    SM750,
    SM750LE,
	SM750HS,   /* SMI FPGA verification version */
	SM750HS_F, /* HiS FPGA verification version */
	SM750HS_A  /* HiS ASIC version */
}
logical_chip_type_t;
...
void ddk750_set_mmio(volatile unsigned char *,unsigned short,unsigned short,char);
